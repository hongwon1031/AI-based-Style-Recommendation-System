...
def make_grid(N, iH, iW, opt):
    ...
    grid = torch.cat([grid_x, grid_y], 3)  # CPU 전용
    return grid
...
def define_D(input_nc, ndf=64, n_layers_D=3, norm='instance', use_sigmoid=False, num_D=2, getIntermFeat=False, Ddownx2=False, Ddropout=False, spectral=False):
